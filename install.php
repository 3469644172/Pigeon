...
$enable_recaptcha = $_POST['recaptcha'];
...
if($enable_recaptcha == "y") {
	...
	$recaptcha_key = $_POST['recaptchakey'];
	
	$recaptcha_key_post = $_POST['recaptchapost'];

$conn = mysqli_connect($db_host, $db_user, $db_pass, $db_name, $db_port);
if(!$conn) {
	die("无法连接到数据库主机！错误：" . mysqli_error($conn));
} else {
  ...
  PRIMARY KEY (`id`)
	...
	echo '<html><meta http-equiv="refresh" content="5;url=/"><body><script>window.alert("安装成功！");</script></body></html>';
}
}else{
    echo <<<EOF
...
<title>Pigeon 安装</title>
<script src="https://apps.bdimg.com/libs/jquery/2.1.4/jquery.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.7/js/bootstrap.min.js" crossorigin="anonymous"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.13.1/highlight.min.js"></script>
<script src="/pigeon/template/pigeon/js/highlight.pack.js"></script>
<style type="text/css">
.testswitch {
    position: relative;
    width: 90px;
...
<span class="input-group-addon" style="border-radius: 6px 0px 0px 0px;"></span>
<input type="text" placeholder="数据库地址"" value="" name="dbhost" class="form-control" required="" style="box-shadow: none;height: 42px;border-radius: 0px 6px 0px 0px;">
</div>
<div class="input-group">
<span class="input-group-addon" style="border-top: 0px;border-radius: 0px;"></span>
<input type="text" placeholder="数据库端口" value="" name="dbport" class="form-control" required="" style="box-shadow: none;height: 42px;border-radius: 0px 6px 0px 0px;">
</div>
<div class="input-group">
<span class="input-group-addon" style="border-top: 0px;border-radius: 0px;"></span>
<input type="text" placeholder="用户名" value="" name="dbuser" class="form-control" required="" style="box-shadow: none;height: 42px;border-radius: 0px 6px 0px 0px;">
</div>
<div class="input-group">
<span class="input-group-addon" style="border-top: 0px;border-radius: 0px;"></span>
<input type="password" placeholder="密码" value="" name="dbpass" class="form-control" required="" style="box-shadow: none;height: 41px;border-radius: 0px;border-top: 0px;">
</div>
<div class="input-group">
<span class="input-group-addon" style="border-top: 0px;border-radius: 0px 0px 0px 6px;"></span>
<input type="text" placeholder="数据库名称" name="dbname" class="form-control" required="" style="box-shadow: none;height: 41px;border-radius: 0px 0px 6px 0px;border-top: 0px;">
</div>

<p>注册</p>
<div class="testswitch">
<input class="testswitch-checkbox" id="registe" type="checkbox">
			<label class="testswitch-label" for="registe">
...
<p>注册邮箱验证</p>
<p><select id="smtp" class="form-control">
...
<div class="input-group">
<span class="input-group-addon" style="border-radius: 6px 0px 0px 0px;"></span>
<input type="text" placeholder="地址" name="smtphost" class="form-control" style="box-shadow: none;height: 41px;border-radius: 0px 0px 6px 0px;border-top: 0px;">
</div>
<div class="input-group">
<span class="input-group-addon" style="border-top: 0px;border-radius: 0px;"></span>
<input type="text" placeholder="端口" name="smtpport" class="form-control" style="box-shadow: none;height: 41px;border-radius: 0px 0px 6px 0px;border-top: 0px;">
</div>
<div class="input-group">
<span class="input-group-addon" style="border-top: 0px;border-radius: 0px;"></span>
<input type="text" placeholder="用户名" name="smtpuser" class="form-control" style="box-shadow: none;height: 41px;border-radius: 0px 0px 6px 0px;border-top: 0px;">
</div>
<div class="input-group">
<span class="input-group-addon" style="border-top: 0px;border-radius: 0px;"></span>
<input type="password" placeholder="密码" name="smtppass" class="form-control" style="box-shadow: none;height: 41px;border-radius: 0px 0px 6px 0px;border-top: 0px;">
</div>
<div class="input-group">
<span class="input-group-addon" style="border-top: 0px;border-radius: 0px 0px 0px 6px;"></span>
<input type="email" placeholder="邮箱" name="smtpmail" class="form-control" style="box-shadow: none;height: 41px;border-radius: 0px 0px 6px 0px;border-top: 0px;">
</div>

<p>谷歌验证码</p>
<p><select id="recaptcha" class="form-control">
	<option value="y">是</option>
	<option value="n">否</option>
	</select></p>
<p>谷歌验证码信息</p>
<div class="input-group">
<span class="input-group-addon" style="border-radius: 6px 0px 0px 0px;"></span>
<input type="text" placeholder="前端验证Key" name="recaptchakey" class="form-control" style="box-shadow: none;height: 41px;border-radius: 0px 0px 6px 0px;border-top: 0px;">
</div>
<div class="input-group">
<span class="input-group-addon" style="border-top: 0px;border-radius: 0px 0px 0px 6px;"></span>
<input type="text" placeholder="后端验证Key" name="recaptchapost" class="form-control" style="box-shadow: none;height: 41px;border-radius: 0px 0px 6px 0px;border-top: 0px;">
</div>

<p>管理员信息</p>
<div class="input-group">
<span class="input-group-addon" style="border-radius: 6px 0px 0px 0px;"></span>
<input type="text" placeholder="用户名" name="adminuser" class="form-control" required="" style="box-shadow: none;height: 41px;border-radius: 0px 0px 6px 0px;border-top: 0px;">
</div>
<div class="input-group">
<span class="input-group-addon" style="border-top: 0px;border-radius: 0px;"></span>
<input type="text" placeholder="昵称" name="adminname" class="form-control" required="" style="box-shadow: none;height: 41px;border-radius: 0px 0px 6px 0px;border-top: 0px;">
</div>
<div class="input-group">
<span class="input-group-addon" style="border-top: 0px;border-radius: 0px;"></span>
<input type="text" placeholder="QQ" name="adminqq" class="form-control" required="" style="box-shadow: none;height: 41px;border-radius: 0px 0px 6px 0px;border-top: 0px;">
</div>
<div class="input-group">
<span class="input-group-addon" style="border-top: 0px;border-radius: 0px;"></span>
<input type="email" placeholder="邮箱" name="adminmail" class="form-control" required="" style="box-shadow: none;height: 41px;border-radius: 0px 0px 6px 0px;border-top: 0px;">
</div>
<div class="input-group">
<span class="input-group-addon" style="border-top: 0px;border-radius: 0px 0px 0px 6px;"></span>
<input type="password" placeholder="密码" name="adminpass" class="form-control" required="" style="box-shadow: none;height: 41px;border-radius: 0px 0px 6px 0px;border-top: 0px;">
</div>
	
<br>
<p><button type="submit" class="btn btn-primary" style="width: 100%;">立即安装</button></p>
